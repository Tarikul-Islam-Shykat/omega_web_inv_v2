...
import 'package:omega_web_inv/User/Auth_Screen/screens/Home/controller/meal_plan_controller.dart';
...
class MealPlan extends StatelessWidget {
  ...
  MealPlan({super.key, required this.calorieCount});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            CustomAppBar(title: 'Meal Plans', centerTitle: true),
            SizedBox(height: 8.h),
            Obx(
              () => Container(
                height: 60.h,
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: Text(
                    'Consumed',
                    style: TextStyle(fontSize: 15.sp, color: Color(0xFF636363)),
                  ),
                ),
              ),
            ),
